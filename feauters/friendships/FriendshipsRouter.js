...
router.post("/sendFriend", AuthMiddleware, checkFriendshipStatus, sendFriendRequestController);
router.post("/acceptFriend", AuthMiddleware, checkAcceptRequest,   AcceptFriendRequestController);
router.post("/cancelFriend", AuthMiddleware, checkCancelRequest, cancelRequestController);
